...
interface VerticalVideoServiceCardProps {
...
const VerticalVideoServiceCard: React.FC<VerticalVideoServiceCardProps> = ({
  sustainabilityLevel,
  availableLevels,
  ...
  const [selectedDuration, setSelectedDuration] = useState('vertical-video-30');

  const durations = [
    { id: 'vertical-video-15', duration: '15 seconds', price: 200 },
    { id: 'vertical-video-30', duration: '30 seconds', price: 400 },
    { id: 'vertical-video-45', duration: '45 seconds', price: 500 }
  ];
  ...
  return (
    <div className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-purple-200 hover:border-purple-300">
      {/* Header */}
      ...
      <button 
        onClick={() => onAddToCart(selectedDuration, `Vertical Video - ${selectedOption.duration}`)}
        className="w-full py-3 bg-purple-500 text-white rounded-xl hover:bg-purple-600 transition-colors font-semibold"
      >
...
export default VerticalVideoServiceCard;